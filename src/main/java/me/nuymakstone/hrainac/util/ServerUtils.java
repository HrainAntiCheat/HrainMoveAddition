...
public final class ServerUtils {
    ...
    public static AABB[] getBlockCollisionBoxesAsyncClientSide(Location loc, HrainACPlayer pp) {
        if (loc.getWorld().isChunkLoaded(loc.getBlockX() >> 4, loc.getBlockZ() >> 4)) {
