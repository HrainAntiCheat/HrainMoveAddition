...
import me.nuymakstone.hrainac.wrap.packet.WrappedPacket7;
...
public final class PacketConverter7 {
    ...
    private static Event packetToInterEvent(PacketPlayInUseEntity packet, Player p, HrainACPlayer pp) {
