 ...
 * specific distance for every succeeding move. HrainMoveAddition's flight
...
public class FlyOld extends MovementCheck implements Listener {
    ...
    //TODO: I suggest getting rid of map lastDeltaY and instead use HrainACPlayer#getVelocity(). Should keep things consistent, especially when moving from liquids to air.
    ...
    public FlyOld() {
        super("fly", true, 0, 10, 0.995, 5000, "%player% 没能绕过 fly. VL: %vl%", null);
